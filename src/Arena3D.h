...
class Arena3D {
    ...
    /**
    * @brief Get the available Entrance From Position object
    *
     * @param point
     * @return int room corresponding to position
    */
    Vector3d<double> GetEntranceCenterFromPosition(const Vector3d<double> &point);

    Vector3d<double> GetEntranceCenterFromPosition(const double &x, const double &y, const double &z);

    /**
  * @brief Get the wall with entrances From Position object
  *
   * @param point
   * @return int room corresponding to position
  */
    Wall *GetWallFromPosition(const Vector3d<double> &point);

    Wall *GetWallFromPosition(const double &x, const double &y, const double &z);
